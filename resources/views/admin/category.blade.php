            ...
            <div class="col-lg-12">
                    <section class="panel">
                        ...
                        ?>
                                ...
                                <button type="submit" name="category" class="btn btn-info">Thêm</button>
                            </form>
                            </div>
            ...
            <div class="panel panel-default">
                ...
                <table class="table table-striped b-t b-light">
                    ...
                    <tr>
                        ...
                        <a onclick="return confirm('Bạn có muốn xoá danh mục này không?')" href="{{URL::to('/delete-category/'.$cate_pro->id)}}" class="active styling-edit" ui-toggle-class="">
